_PLEASE NOTE: This verbiage is for the ASWF 2020 v2.1 ICLA and must be approved by the project's TSC before use; if your project is using a different ICLA, put the correct language in here._ 
